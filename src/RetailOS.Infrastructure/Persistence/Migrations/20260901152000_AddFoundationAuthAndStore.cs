...
{
    /// <inheritdoc />
    public partial class AddFoundationAuthAndStore : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    timezone = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, defaultValue: "Africa/Cairo"),
                    ...
                    invoice_prefix = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true, defaultValue: "INV"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_asp_net_users_stores_store_id",
                        column: x => x.store_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_refresh_tokens_stores_store_id",
                        column: x => x.store_id,
                        principalTable: "stores",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_asp_net_users_store_id",
                table: "AspNetUsers",
                column: "store_id");

            migrationBuilder.CreateIndex(
                name: "ix_asp_net_users_store_id_is_active",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_refresh_tokens_store_id",
                table: "refresh_tokens",
                column: "store_id");
