...
public class SaleReturnLineItemConfiguration : IEntityTypeConfiguration<SaleReturnLineItem>
{
    public void Configure(EntityTypeBuilder<SaleReturnLineItem> builder)
    {
        builder.ToTable("sale_return_line_items");
        ...
        builder.HasIndex(li => li.SaleReturnId);
        builder.HasIndex(li => li.ProductId);

        builder.HasOne(li => li.SaleReturn)
            .WithMany(sr => sr.LineItems)
            .HasForeignKey(li => li.SaleReturnId)
