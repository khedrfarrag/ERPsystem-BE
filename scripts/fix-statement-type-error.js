...
// 1. Update merchantsApi.ts
const apiPath = path.resolve(__dirname, '../src/../../system-FE/src/features/b2b/api/merchantsApi.ts');
...
console.log('merchantsApi.ts updated successfully.');

// 2. Update PortalStatement.tsx
const statementPath = path.resolve(__dirname, '../src/../../system-FE/src/pages/portal/PortalStatement.tsx');

const statementCode = `import React, { useState } from 'react';
...
fs.writeFileSync(statementPath, statementCode, 'utf8');
console.log('PortalStatement.tsx updated successfully.');
